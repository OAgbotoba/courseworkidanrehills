...
<body class="animsition">
	...
	<section class="bgwhite p-t-66 p-b-38">
		<div class="container py-5" style="position:relative; display:block; margin:3%">
                <div class="col-md-12">
                <h3 style="text-shadow: .1rem .1rem .5rem #3600D9; font-weight:bold">Tourists Shared Gallery</h3>
		
                </div>
			<div class="row">
				<!-- Session Status -->
                <?php
                $query=mysqli_query($conn, "SELECT * FROM experinsert WHERE status=1 ORDER BY created_on desc");
            ...
            <img src="alluploaswerqweben/<?php echo $result['img']; ?>" alt=""  style="margin:7%" width="250px" height="250px">
                    
                <div class="card-body">
                    <h2 class="card-title" style="font-size:20px; text-shadow: .1rem .1rem .5rem #3600D9; color:#3600D9; font-weight:bold"><?php echo $result['place']; ?></h2>
                </div>
            </div>
    </div>
                <?php

...
<body class="animsition">
	...
	<section class="bgwhite p-t-66 p-b-38">
		...
		<h3 style="text-shadow: .1rem .1rem .5rem #3600D9; font-weight:bold">Idanre Hills: 640 Steps</h3>
			<article></article>
        <!-- Validation Errors -->
		<p style="font-size:16px;">For tourist to get to the top of the hills where the ancient city is located, they will have to climb an amazing 640 stair steps. There are four resting place where tourist can relax before continuing their journey to the top of the hills. In each of the resting place, tourist, there is opportunity for them to have the area view of the town as they are going while climbing.</p>
        
		</div>
		 <!-- Session Status -->
		 <div class="col-lg-6 col-sm-12">
		 	 <div class="v31_116"><img src="asset/images/hill4.png" style="top:-80px;"></div>
			 </div>

...
<body class="animsition">
  ...
  <div class="card-body">
        ...
        <form method="POST" action="" style="margin:6%;">
		<br>
                    <?php echo Message(); 
                            echo SuccessMessage(); 
                        ?>
                    <br>
             <br>
			<p class="vs_211">Sign In</p>
            <!-- Email Address -->
            <div class="form-group">
                <label for="email">Email</label>

                <input id="email" class="form-control mt-1 w-full inputs" id="inp" type="email" name="username">
			...
			<div class="form-group">
                ...
                <input id="password" class="form-control mt-1 w-full inputs" id="inp" type="password"  name="password">
				<span class="text-danger"></span>
            </div>
			...
			<p style="color:red">Interested to join? Click to <a href="register.php" style="font-weight:bold;color:#3600D9">Sign Up</a></p>
        </form>
    </div>
		 ...
		 <!-- Session Status -->
		 <div class="col-sm">
		 	 <div class="v31_112"><img src="asset/images/v31_112.png"></div>
			 <div class="v22_198"><img src="asset/images/v22_198.png"></div>
			 
			 <div class="v31_111"><img src="asset/images/v31_111.jpg"></div>
		</div>
	</section>

...
<body class="animsition">
	...
	<section class="bgwhite p-t-66 p-b-38">
		...
		<h3 style="text-shadow: .1rem .1rem .5rem #3600D9; font-weight:bold">Idanre Hills: Agboogun Foot Print</h3>
			<article></article>
        <!-- Validation Errors -->
		<p style="font-size:16px;">Agboogun Foot print is a foot print on the top of a flat rock. It was the foot print of a Great warrior and Chief who died hundreds of years ago. The foot print on the top of the flat rock is like the shape of human feet. The foot print is believe to size any human leg believe to be without blemished. Any person who places his/her foot on the foot print and it does not size them, its mean that such is an evil person. </p>
        
		</div>
		 <!-- Session Status -->
		 <div class="col-lg-6 col-sm-12">
		 	 <div class="v31_116"><img src="asset/images/v31_26.png" style="top:-80px;"></div>
			 </div>

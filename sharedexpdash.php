...
<ul class="sidebar-menu" data-widget="tree">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="info-box ">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Tourist Visit</span>
                    <span class="info-box-number"></span>
                    ...
                    <div class="progress">
                      <div class="progress-bar" style="width: 0%"></div>
                        ...
                        <span class="progress-description">
                          Shared Experience 
                    <?php
                $queryapproved=mysqli_query($conn, "SELECT COUNT(*) FROM experinsert");
                $result=mysqli_fetch_assoc($queryapproved);
                $total=array_shift($result);
                if ($total>0){
              ...
              <div class="col-lg-10">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                      ...
                      <h3 class="box-title">Tourist Experience</h3>
                    </div>
    ...
    <div class="table-responsive">      
                    ...
                    <table id="empTable" class="table table-striped table-bordered table-hover display dataTable" style="width:93%; font-size:12px; overflow-x:auto; overflow-y:auto; margin-right: 3%; margin-top:30px; margin-left:1%;background:#fff;">
                        ...
                        <?php 
                                $query=mysqli_query($conn, "SELECT * FROM experinsert ORDER BY created_on desc");
                    ...
                    while($result=mysqli_fetch_assoc($query)){
                        ...
                        <tr>
                            ...
                            <td><img src="alluploaswerqweben/<?php echo $result['img'];?>" style="width:100px;height:100px; border-radius:50%"></td>
                            
                            <td><?php echo $result['created_on'];?></td>
                            
                            <td><?php if ($result['status']=='0') {?>
                
                                <a onclick = "return confirm('Click OK to Activate  for the Gallery page?')" href="adminact.php?deltss=<?php echo $result['id']; ?>"><span class="btn btn-success btn-sm" style="font-size: 10px">Activate</span>
                            <?php  } if ($result['status']=='1') {?>
                                <a onclick = "return confirm('Click OK to Suspend this Image from Galllery page?')" href="adminact.php?delsts=<?php echo $result['id']; ?>"><span class="btn btn-warning btn-sm" style="font-size: 10px">Disapprove</span>

...
<body class="animsition">
	...
	<section class="bgwhite p-t-66 p-b-38">
		...
		<h3 style="text-shadow: .1rem .1rem .5rem #3600D9; font-weight:bold">Idanre Hills: Resort</h3>
			<article></article>
        <!-- Validation Errors -->
		<p style="font-size:16px;">The Resort Center is a relaxation place for all tourists to relax before starting the journey to the Ancient City at the top of the hills. It is also a place where tourist can visit and ask questions about the hills from dedicated staff.</p>
